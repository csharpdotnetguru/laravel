...
{{ HTML::linkRoute('home', 'Back To Home', null, ['class' => 'btn btn-primary']) }}</li>
{{ Form::model($user, array('route' => array('user_profile_update'), 'method' => 'PUT')) }}
...
<br />  
    ...
    <div class="control-group">
      ...
      <div class="controls">
        <!--<input type="text" name='address1' class="required" id="address1" >-->
    ...
    <div class="control-group">
      ...
      <div class="controls">
		...
		{{ Form::select('country', get_countries(), null, array('class' => 'required','id'=>'location_country')) }}
    ...
    <div class="control-group">
      ...
      <div class="controls">
        <!-- <input type="text" name='postcode' class="required" id="postcode" > -->
...
<br />
  ...
  <div class="control-group" id="new_password">
	...
	<div class="form-actions">
		<button type="submit" id='sign_up_submit' class="btn btn-success">Save Profile</button>
	</div>
  </fieldset>
</form>
  </div>
