...
class WebGuy extends \Codeception\AbstractGuy
{
    ...
    * Conditional Assertion: Test won't be stopped on fail
     ...
     *
     *
     * @see Codeception\Module\WebDriver::goToUrl()
     * @return \Codeception\Maybe
     */
    public function goToUrl($url) {
        $this->scenario->addStep(new \Codeception\Step\Action('goToUrl', func_get_args()));
        if ($this->scenario->running()) {
            $result = $this->scenario->runStep();
            return new Maybe($result);
        }
     ...
     *
     *
     * @see Codeception\Module\WebDriver::findElementById()
     * @return \Codeception\Maybe
     */
    public function findElementById($element_id) {
        $this->scenario->addStep(new \Codeception\Step\Action('findElementById', func_get_args()));
        if ($this->scenario->running()) {
            $result = $this->scenario->runStep();
            return new Maybe($result);
        }
     ...
     *
     *
     * @see Codeception\Module\WebDriver::findElementByXpath()
     * @return \Codeception\Maybe
     */
    public function findElementByXpath($xpath) {
        $this->scenario->addStep(new \Codeception\Step\Action('findElementByXpath', func_get_args()));
        if ($this->scenario->running()) {
            $result = $this->scenario->runStep();
            return new Maybe($result);
        }
     ...
     *
     *
     * @see Codeception\Module\WebDriver::clickByXpath()
     * @return \Codeception\Maybe
     */
    public function clickByXpath($xpath) {
        $this->scenario->addStep(new \Codeception\Step\Action('clickByXpath', func_get_args()));
        if ($this->scenario->running()) {
            $result = $this->scenario->runStep();
            return new Maybe($result);
        }
     ...
     *
     *
     * @see Codeception\Module\WebDriver::clickById()
     * @return \Codeception\Maybe
     */
    public function clickById($element_id) {
        $this->scenario->addStep(new \Codeception\Step\Action('clickById', func_get_args()));
        if ($this->scenario->running()) {
            $result = $this->scenario->runStep();
            return new Maybe($result);
        }
