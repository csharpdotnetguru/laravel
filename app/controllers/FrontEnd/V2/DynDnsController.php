...
class DynDnsController extends BaseController {
    ...
    public function index()
    {
        ...
        return View::make('v2.frontend.dyndns.index')
            ->with('dyndns', $dyndns)
            ->with('dyn', 'active');
    }
    ...
    {
        $uid = $this->uid;
        return View::make('v2.frontend.dyndns.create')
            ->with('uid', $uid);
    }
    ...
    {
        $uid = $this->uid;
        $dyndns = $this->dyndns_interface->find_dyndns_by_id($dyndns_id);

        return View::make('v2.frontend.dyndns.edit')
            ->with('uid', $uid)
            ->with('hostname', $dyndns->hostname)
